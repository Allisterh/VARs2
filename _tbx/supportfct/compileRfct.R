...
## Load packages ----
# gdata is deprecated. Use readxl instead
...
# Note: Use tidyverse functions for easier data handling
if (!require("tidyverse")) install.packages("tidyverse")
library(tidyverse)
library(readxl) # Non-core tidyverse, needs to be loaded seperately
